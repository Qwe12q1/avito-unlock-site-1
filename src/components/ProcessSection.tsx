...
const ProcessSection: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'Наши специалисты изучат причину блокировки и свяжутся с вами для уточнения деталей',
      icon: '🔍',
      delay: 100,
    },
    {
      title: 'Разблокировка',
      description: 'Мы подготовим и отправим необходимые документы и заявления в Авито',
      icon: '🔓',
      delay: 200,
    }
  ];
